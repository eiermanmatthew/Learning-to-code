...
var userWins = 0;
var computerWins = 0;
var results = {"scissorspaper" : "cuts", //Scissors cuts paper
...
userWins++;
return user+" "+results[user+""+computer]+" "+computer;
} else { //computer beats user
computerWins++;
return computer+" "+results[computer+"_"+user]+" "+user;
}
}
//loop until the user enters something invalid
do {
var bored = true;
var userChoice = prompt("Do you choose "+choices+"?").toLowerCase();
...
console.log("You won "+userWins+" and the computer won "+computerWins);
